...
namespace Saklient.Cloud.Errors
{
	...
	public class AccessXhrOrApiKeyException : HttpForbiddenException
	{
		...
		/// <param name="message" />
		/// </summary>
		public AccessXhrOrApiKeyException(long status, string code=null, string message="") : base(status, code, string.IsNullOrEmpty(message) ? "要求された操作は許可されていません。XHRまたはAPIキーによるアクセスのみ許可されています。" : message)
		{
			/*!base!*/;
		}
