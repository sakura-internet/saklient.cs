...
namespace Saklient.Cloud.Errors
{
	...
	public class ApiProxyTimeoutException : HttpGatewayTimeoutException
	{
		...
		/// <param name="message" />
		/// </summary>
		public ApiProxyTimeoutException(long status, string code=null, string message="") : base(status, code, string.IsNullOrEmpty(message) ? "APIプロクシがタイムアウトしました。サーバが混雑している可能性があります。" : message)
		{
			/*!base!*/;
		}
