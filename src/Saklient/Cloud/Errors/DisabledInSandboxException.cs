...
namespace Saklient.Cloud.Errors
{
	...
	public class DisabledInSandboxException : HttpForbiddenException
	{
		...
		/// <param name="message" />
		/// </summary>
		public DisabledInSandboxException(long status, string code=null, string message="") : base(status, code, string.IsNullOrEmpty(message) ? "要求された操作は許可されていません。このゾーンではこの操作は禁止されています。他のゾーンでお試しください。" : message)
		{
			/*!base!*/;
		}
