...
namespace Saklient.Cloud.Errors
{
	...
	public class DnsARecordNotFoundException : HttpBadRequestException
	{
		...
		/// <param name="message" />
		/// </summary>
		public DnsARecordNotFoundException(long status, string code=null, string message="") : base(status, code, string.IsNullOrEmpty(message) ? "不適切な要求です。対応するAレコードが見つかりません。" : message)
		{
			/*!base!*/;
		}
