...
namespace Saklient.Cloud.Errors
{
	...
	public class FilterArrayComparisonException : HttpBadRequestException
	{
		...
		/// <param name="message" />
		/// </summary>
		public FilterArrayComparisonException(long status, string code=null, string message="") : base(status, code, string.IsNullOrEmpty(message) ? "不適切な要求です。配列とは比較できない演算子がフィルタ中に含まれています。" : message)
		{
			/*!base!*/;
		}
