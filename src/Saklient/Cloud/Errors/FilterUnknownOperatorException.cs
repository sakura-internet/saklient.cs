...
namespace Saklient.Cloud.Errors
{
	...
	public class FilterUnknownOperatorException : HttpBadRequestException
	{
		...
		/// <param name="message" />
		/// </summary>
		public FilterUnknownOperatorException(long status, string code=null, string message="") : base(status, code, string.IsNullOrEmpty(message) ? "不適切な要求です。不明な演算子がフィルタ中に含まれています。" : message)
		{
			/*!base!*/;
		}
