...
namespace Saklient.Cloud.Errors
{
	...
	public class MissingParamException : HttpBadRequestException
	{
		...
		/// <param name="message" />
		/// </summary>
		public MissingParamException(long status, string code=null, string message="") : base(status, code, string.IsNullOrEmpty(message) ? "不適切な要求です。必要なパラメータが指定されていません。" : message)
		{
			/*!base!*/;
		}
