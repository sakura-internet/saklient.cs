...
namespace Saklient.Cloud.Errors
{
	...
	public class OperationFailureException : HttpServiceUnavailableException
	{
		...
		/// <param name="message" />
		/// </summary>
		public OperationFailureException(long status, string code=null, string message="") : base(status, code, string.IsNullOrEmpty(message) ? "サービスが利用できません。操作に失敗しました。サーバが混雑している可能性があります。" : message)
		{
			/*!base!*/;
		}
