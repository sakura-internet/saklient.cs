...
namespace Saklient.Cloud.Errors
{
	...
	public class PaymentRegistrationException : HttpPaymentRequiredException
	{
		...
		/// <param name="message" />
		/// </summary>
		public PaymentRegistrationException(long status, string code=null, string message="") : base(status, code, string.IsNullOrEmpty(message) ? "要求を受け付けできません。支払情報が未登録です。会員メニューから支払、クレジットカードの情報を登録してください" : message)
		{
			/*!base!*/;
		}
