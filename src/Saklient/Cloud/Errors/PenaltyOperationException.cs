...
namespace Saklient.Cloud.Errors
{
	...
	public class PenaltyOperationException : HttpPaymentRequiredException
	{
		...
		/// <param name="message" />
		/// </summary>
		public PenaltyOperationException(long status, string code=null, string message="") : base(status, code, string.IsNullOrEmpty(message) ? "お客様のご都合により操作を受け付けることができません。" : message)
		{
			/*!base!*/;
		}
