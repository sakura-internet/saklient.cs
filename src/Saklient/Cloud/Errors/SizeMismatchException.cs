...
namespace Saklient.Cloud.Errors
{
	...
	public class SizeMismatchException : HttpBadRequestException
	{
		...
		/// <param name="message" />
		/// </summary>
		public SizeMismatchException(long status, string code=null, string message="") : base(status, code, string.IsNullOrEmpty(message) ? "不適切な要求です。参照するリソースのサイズが合致しません。" : message)
		{
			/*!base!*/;
		}
